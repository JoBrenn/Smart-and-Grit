...
class HillClimber:
    ...
    Methods:
        random_start_state():       create random start state of district
        ...
        check_valid():              check if district configuration is valid
    ...
    def random_change(self, district: District, costs_type: str) -> District:
        ...
        district.output[0] = {"district": district.district,
                              f"{costs_type}":
                              self.return_total_cost(district)}
    ...
    def check_valid(self, district: District) -> bool:
        ...
        # Check whether there is still a penalty
        for battery in district.batteries:
    ...
    def run_hill_climber(self, district: District, n: int,
                         N: int = 1000) -> District:
        ...
        filename = "output/JSON/best_output_switch_combination.json"
